...
async function init(){
    ...
    await fetch("https://raw.githubusercontent.com/coolpilot11/GEOFS-LiverySelector-test/main/livery.json").then(res => res.json()).then(data => liveryobj = data)
